                ...
                <div class="navbar-nav ms-auto">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu custom-navbar-dropdown" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item active" href="#">Main/Alerts</a></li>
    ...
    <div class="scroll-container">
        <div class="internal-container">
            ...
            <div class="container my-4">
                <h1 class="mt-4 text-center">User Admin - Logged in Main Page.</h1>
                <p class="lead text-center">Welcome to your user admin page. Here you can manage your account settings, view your activity, and access exclusive content.</p>
                <hr>

                <h3 class="my-4 text-center">User Dashboard</h3>
                ...
                <div class="col-12 col-lg-8 p-3 d-pad-2" style="background-color:var(--primary-pane-bg-color);border:2px solid var(--dark-border-color);">
                    ...
                    <table class="projects-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="#" class="main-link">ALL</a></td>
            ...
            <!-- BootStrap Container System; Footer??? -->
            <!-- <div class="container">
                <hr class="py-2">
            </div> -->
