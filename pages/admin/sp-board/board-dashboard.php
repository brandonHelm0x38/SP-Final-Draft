    ...
    <div class="scroll-container">
        <div class="internal-container">
            ...
            <div class="container my-4">
                <h1 class="mt-4 text-center">SP Board User - Logged in Main Page.</h1>
                <p class="lead text-center">Board/Author/User profile management, alerts, create a newsletter, create a project, add linked-content</p>
                <p>Two unique privelege for SP-Board...</p>
                <ul>
                    <li>1) Manage active priorities point-of-origin archive.</li>
                    <li>2) Manage GL nodes and learning subject icon mapping. This is a complex aspect of the website. When a FeaturePage is loaded, the GL nodes and learning subject icons must be mapped correctly to display the relevant content. They also must be mapped relevant to quiz crediting. The page must load all the query quiz metric results and ensure the mapping is accurate for both display and crediting purposes.</li>
                </ul>
                <hr>

                <h3 class="my-4 text-center">SP-Board Dashboard</h3>
                    ...
                    <div class="offcanvas-lg offcanvas-start bg-light" tabindex="-1" id="sidebarAside" aria-labelledby="sidebarLabel">
                        ...
                        <div class="offcanvas-body p-3" style="border:2px solid var(--dark-border-color);">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item my-2"><a href="#" class="main-link">Manage Featured Priorities</a></li>
                                <li class="nav-item my-2"><a href="#" class="main-link">Manage Subject-Node Relationships</a></li>
            ...
            <!-- BootStrap Container System; Page metrics; Possible Additional Admin Functions at end (e.g. reporting queries)-->
            <div class="container">
                <hr>
                <h4 class="mt-4 text-center">Admin Metrics</h4>
                <p class="lead text-center">Reporting queries to support...</p>
                <ul class="list-unstyled text-center">
                    <li>1) Top Projects by Views (Name, Priority, Views)</li>
                    <li>2) Top Newsletters by Views (Title, Author, Views)</li>
                </ul>
            </div>
