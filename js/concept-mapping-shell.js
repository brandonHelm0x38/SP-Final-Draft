...
// When you reference a file-path in JavaScript... It is relevant to the HTML file calling the script.
// My framework must step back one folder as in this project featurePage.php is in the pages folder, which is in the root.
const cubes = [
  { texture: loadTexture(gl, '../../../images/gl_images/gl_learningIcons/Genetics_SubjectIcon.jpg'), 
    translation: [-2, -2, 0], 
    color: [1.0, 0.0, 0.0, 1.0], 
    category: '0-Genetics' },
  { texture: loadTexture(gl, '../../../images/gl_images/gl_learningIcons/Physics_SubjectIcon.jpg'), 
    translation: [ 0, 0, 0], 
    color: [0.0, 1.0, 0.0, 1.0], 
    category: '1-Physics' },
  { texture: loadTexture(gl, '../../../images/gl_images/gl_learningIcons/Chemistry_SubjectIcon.jpg'), 
    translation: [ 2, -2, 0], 
    color: [0.0, 0.0, 1.0, 1.0], 
    category: '2-Chemistry' },
  { texture: loadTexture(gl, '../../../images/gl_images/gl_learningIcons/Presentation_CourseIcon.jpg'), 
    translation: [ -2, 2, 0], 
    color: [1.0, 0.0, 1.0, 1.0], 
    category: '3-Physics > Presentation' },
  { texture: loadTexture(gl, '../../../images/gl_images/gl_learningIcons/Article_CourseIcon.jpg'), 
    translation: [ 2, 2, 0], 
  ...
  {
    texture: loadTexture(gl, '../../../images/gl_images/uploaded/SP_logo.PNG'), 
    translation: [-5, -3, 0],
